SELECT
  ...
  bytearray_to_uint256(bytearray_substring (data, 99, 2)) as "fee",
  bytearray_substring (data, 113, 20) as "recipient", 
  bytearray_to_uint256(bytearray_substring (data, 161, 4)) as "deadline", 
  bytearray_to_uint256(bytearray_substring (data, 190, 4)) as "amountIn", 
  bytearray_to_uint256(bytearray_substring (data, 218, 4)) as "amountOutMinimum", 
  data
FROM
